...
export const UpdateApplication = ({route}) => {
  const navigate = useNavigation();
const {updating,appId}=route.params;
  return (
    <View style={style.container}>
      <HomeComponent title={'Update Enrollment'} backIcon={true} />
      <View style={style.bottom_container}>
        <Form updating={updating} appId={appId} />
      </View>
